        ...
        <div className="container-fluid">
          ...
          <div className="row">
            {services.map((service, index) => (
              <div
                key={index}
                className={`col-lg-3 col-md-12 m-top-${index === 0 ? 0 : 40} m-bottom-40`}
                data-aos="fade-up"
                data-aos-delay={service.delay}
              >
                <div className="service bg-light-2 border-1 border-light box-shadow-1 box-shadow-2-hover">
                  <div className="media">
                    <i className={`${service.iconClass} bg-base text-white rounded-100 box-shadow-1 p-top-5 p-bottom-5 p-right-5 p-left-5`} />
                  </div>
                  <div className="agent-section p-top-35 p-bottom-30 p-right-25 p-left-25">
                    <h4 className="m-bottom-15 text-bold-700">{service.title}</h4>
