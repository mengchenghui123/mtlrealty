...
!(function (t, n) {
  ...
  function S(n, o, i) {
    function a(t) {
      S[t] ||
        ...
        (S[t] = new A.classes.Marker(_[t].options)),
        l(n, { td: _[t] }, S[t], _[t].id));
    }
    function r() {
      ...
      (k.clear = function (t, n, e) {
        ...
        for (
          t
            ...
            : ((o = 0), (i = _.length), (a = 1)),
            r = o;
          r !== i && (!_[r] || (l && !l(_[r].tag)) || (u.push(T[r]), !n && !t));
          r += a
        );
  ...
  function U(i) {
    ...
    function v(n, e) {
      ...
      E
        ? o && (o.center && (o.center = m(o.center)), E.setOptions(o))
        : ((o = e.opts || t.extend(!0, {}, A.map, o || {})),
          (o.center = n || m(o.center)),
          (E = new A.classes.Map(i.get(0), o)));
    }
    function w(e) {
      var o,
        a,
    ...
    (x._plan = function (t) {
                    ...
                    ? (n.td.cluster instanceof _
                      ...
                      t.each(n.td.values, function (t, e) {
                        ...
                        (o.options.position = m(
                          ...
                          o.options.position &&
                            ((o.options.map = E),
                            u && (E.setCenter(o.options.position), (u = !1)),
                            a.add(o, e));
                      }),
                      a.endUpdate(),
                      g(n, o))
                    : ((e = []),
                      t.each(n.td.values, function (t, o) {
                        ...
                        (s.options.position = m(
                          ...
                          s.options.position &&
                            ((s.options.map = E),
                            u && (E.setCenter(s.options.position), (u = !1)),
      ...
      (x.getelevation = function (t) {
        ...
        if (t.latLng) e.push(t.latLng);
          ...
          for (e = h(t.td.locations || []), n = 0; n < e.length; n++)
            e[n] = m(e[n]);
        if (e.length) T().getElevationForLocations({ locations: e }, o);
        else {
          if (t.td.path && t.td.path.length)
            for (n = 0; n < t.td.path.length; n++) e.push(m(t.td.path[n]));
          e.length
            ? T().getElevationAlongPath({ path: e, samples: t.td.samples }, o)
            : b.ack();
        }
      }),
          ...
          n.td.values.length
            ? (t.each(n.td.values, function (t, o) {
                ...
                (s.options.bounds = y(s.options.bounds ? s.options.bounds : o)),
                  E || v(s.options.bounds.getCenter()),
                  (s.options.map = E),
      ...
      (x.transitlayer = function (t) {
        ...
        n ||
          ((n = new A.classes.TransitLayer()),
          n.setMap(E),
          I.add(t, "transitlayer", n)),
          g(t, n);
      }),
      ...
      (x.autofit = function (n) {
        ...
        t.each(I.all(), function (t, n) {
          ...
          e.isEmpty() ||
            (E.getBounds() && E.getBounds().equals(e)) ||
            ("maxZoom" in n.td &&
              q.event.addListenerOnce(E, "bounds_changed", function () {
      ...
      t.each(this, function () {
        ...
        (o = !1),
          ...
          1 !== e.length || ("get" !== e[0] && !x(e[0]))
            ...
            : "get" === e[0]
            ? i.push(a.get("map", !0))
            : i.push(a.get(e[0].get, !0, e[0].get.full));
      }),
